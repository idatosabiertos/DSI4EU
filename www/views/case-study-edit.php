...
?>
        ...
        <div class="content-block">
            <div class="w-row">
                <div class="w-col w-col-8">
                    <h1 class="content-h1">Editar caso de estudio</h1>
                </div>
                <div class="sidebar w-col w-col-4">
                    ...
                    <a class="sidebar-link" href="<?php echo $urlHandler->addCaseStudy() ?>"><span
                            class="green">-&nbsp;</span>Editar caso de estudio</a>
                    ...
                    <form id="email-form-2" name="email-form-2" ng-submit="save()">
                        <div class="w-row">
                            <div class="form-col-left w-col w-col-6">
                                ...
                                <label for="name-3">Texto de introducción:</label>
                                <input class="creator-data-entry w-input" data-name="Name 3" id="name-3" maxlength="256"
                                       ng-model="caseStudy.introCardText"
                                       name="name-3" placeholder="Este texto aparece en la introducción de la tarjeta" type="text">
                                <label>Introducción de la página:</label>
                                ...
                                <textarea class="creator-data-entry end long-description w-input"
                                          placeholder="Este es el texto principal"
    ...
    `                           */ ?>
                        ...
                        <div class="tabbed-nav-buttons w-clearfix">
                            <input type="submit" class="tab-button-2 tab-button-next w-button" value="Guardar"/>
                            <a href="<?php echo $urlHandler->caseStudy($caseStudy) ?>"
                               class="tab-button-2 tab-button-next w-button">Ver caso de estudio</a>
                        </div>
                    </form>
                </div>
            </div>
